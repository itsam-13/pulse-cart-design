...
export const products: Product[] = [
  {
    ...
    stock: 45,
    images: ['https://images.unsplash.com/photo-1526498460520-4c246339dccb?w=500'],
    specifications: {
      'Colors': '12',
      'Tip Size': '0.7mm',
      'Ink Type': 'Gel',
  ...
  },
  {
    ...
    price: 9,
    image: 'https://images.unsplash.com/photo-1580400013442-23de39748e30?w=500',
    category: 'pens & pencils',
    rating: 4.4,
    reviews: 445,
    description: 'Professional sketching pencil set with varying grades. Ideal for artists and students.',
    stock: 89,
    images: ['https://images.unsplash.com/photo-1580400013442-23de39748e30?w=500'],
    specifications: {
      'Quantity': '12 pencils',
      'Grades': 'HB, 2B, 4B, 6B',
      'Type': 'Graphite',
  ...
  },
  {
    ...
    price: 22,
    image: 'https://images.unsplash.com/photo-1455390582262-1a1ff7c8e1dd?w=500',
    category: 'notebooks',
    rating: 4.9,
    reviews: 178,
    description: 'Large format sketchbook with thick acid-free paper. Perfect for all drawing media.',
    stock: 42,
    images: ['https://images.unsplash.com/photo-1455390582262-1a1ff7c8e1dd?w=500'],
    specifications: {
      'Size': 'A3',
      'Pages': '100',
